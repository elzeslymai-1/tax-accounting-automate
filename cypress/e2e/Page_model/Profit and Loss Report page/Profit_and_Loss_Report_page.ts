...
let validate_view_monthly_category2 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[10]/div[1]'
let validate_view_monthly_subcategory1 = '.mt-7 > :nth-child(2) > .flex > :nth-child(1)'
let validate_view_monthly_subcategory2 = ':nth-child(12) > :nth-child(2) > :nth-child(1)'
let validate_view_monthly_subcategory3 = ':nth-child(12) > :nth-child(3) > :nth-child(1)'
let validate_view_monthly_amountTHB1 = ':nth-child(2) > .flex > .font-semibold'
let validate_view_monthly_amountTHB2 = ':nth-child(12) > :nth-child(2) > .font-semibold'
let validate_view_monthly_amountTHB3 = ':nth-child(12) > :nth-child(3) > .font-semibold'
let validate_view_monthly_total1 = '.mt-7 > :nth-child(3) > .font-semibold'
let validate_view_monthly_total2 = ':nth-child(13) > .font-semibold'
...
let validate_view_month_category2 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[9]/div[1]'
let validate_view_month_subcategory1 = '.mt-7 > :nth-child(2) > .flex > :nth-child(1)'
let validate_view_month_subcategory2 = ':nth-child(11) > .flex > :nth-child(1)'
let validate_view_month_amountTHB1 = ':nth-child(2) > .flex > .font-semibold'
let validate_view_month_amountTHB2 = ':nth-child(11) > .flex > .font-semibold'
let validate_view_month_total1 = ':nth-child(3) > .font-semibold'
let validate_view_month_total2 = ':nth-child(12) > .font-semibold'
...
let validate_view_quarter_category2 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[11]/div[1]'
let validate_view_quarter_category3 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[12]/div[1]'
let validate_view_quarter_category4 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[13]/div[1]'
let validate_view_quarter_subcategory1 = '.mt-7 > :nth-child(2) > .flex > :nth-child(1)'
let validate_view_quarter_subcategory2 = ':nth-child(13) > .flex > :nth-child(1)'
let validate_view_quarter_subcategory3 = ':nth-child(14) > .flex > :nth-child(1)'
let validate_view_quarter_subcategory4 = ':nth-child(15) > .flex > :nth-child(1)'
let validate_view_quarter_amountTHB1 = ':nth-child(2) > .flex > .font-semibold'
let validate_view_quarter_amountTHB2 = ':nth-child(13) > .flex > .font-semibold'
let validate_view_quarter_amountTHB3 = ':nth-child(14) > .flex > .font-semibold'
let validate_view_quarter_amountTHB4 = ':nth-child(15) > .flex > .font-semibold'
let validate_view_quarter_total1 = ':nth-child(3) > .font-semibold'
let validate_view_quarter_total2 = ':nth-child(16) > .font-semibold'
...
let validate_view_year_category2 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[3]/div[1]'
let validate_view_year_category3 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[4]/div[1]'
let validate_view_year_category4 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[5]/div[1]'
let validate_view_year_category5 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[19]/div[1]'
let validate_view_year_category6 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[20]/div[1]'
let validate_view_year_category7 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[21]/div[1]'
let validate_view_year_category8 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[22]/div[1]'
let validate_view_year_category9 = '//*[@id="__next"]/div/div[2]/div/section/section/main/div/div[2]/div/div/div[2]/div/div[23]/div[1]'
let validate_view_year_subcategory1 = '.mt-7 > :nth-child(2) > .flex > :nth-child(1)'
let validate_view_year_subcategory2 = ':nth-child(3) > .flex > :nth-child(1)'
let validate_view_year_subcategory3 = ':nth-child(4) > .flex > :nth-child(1)'
let validate_view_year_subcategory4 = ':nth-child(5) > .flex > :nth-child(1)'
let validate_view_year_subcategory5 = ':nth-child(21) > .flex > :nth-child(1)'
let validate_view_year_subcategory6 = ':nth-child(22) > .flex > :nth-child(1)'
let validate_view_year_subcategory7 = ':nth-child(23) > .flex > :nth-child(1)'
let validate_view_year_subcategory8 = ':nth-child(24) > :nth-child(2) > :nth-child(1)'
let validate_view_year_subcategory9 = ':nth-child(24) > :nth-child(3) > :nth-child(1)'
let validate_view_year_subcategory10 = ':nth-child(24) > :nth-child(4) > :nth-child(1)'
let validate_view_year_subcategory11 = ':nth-child(24) > :nth-child(5) > :nth-child(1)'
let validate_view_year_subcategory12 = ':nth-child(25) > :nth-child(2) > :nth-child(1)'
let validate_view_year_subcategory13 = ':nth-child(25) > :nth-child(3) > :nth-child(1)'
let validate_view_year_amountTHB1 = ':nth-child(2) > .flex > .font-semibold'
let validate_view_year_amountTHB2 = ':nth-child(3) > .flex > .font-semibold'
let validate_view_year_amountTHB3 = ':nth-child(4) > .flex > .font-semibold'
let validate_view_year_amountTHB4 = ':nth-child(5) > .flex > .font-semibold'
let validate_view_year_amountTHB5 = ':nth-child(21) > .flex > .font-semibold'
let validate_view_year_amountTHB6 = ':nth-child(22) > .flex > .font-semibold'
let validate_view_year_amountTHB7 = ':nth-child(23) > .flex > .font-semibold'
let validate_view_year_amountTHB8 = ':nth-child(24) > :nth-child(2) > .font-semibold'
let validate_view_year_amountTHB9 = ':nth-child(24) > :nth-child(3) > .font-semibold'
let validate_view_year_amountTHB10 = ':nth-child(4) > .font-semibold'
let validate_view_year_amountTHB11 = ':nth-child(5) > .font-semibold'
let validate_view_year_amountTHB12 = ':nth-child(25) > :nth-child(2) > .font-semibold'
let validate_view_year_amountTHB13 = ':nth-child(25) > :nth-child(3) > .font-semibold'
let validate_view_year_total1 = ':nth-child(6) > .font-semibold'
let validate_view_year_total2 = ':nth-child(26) > .font-semibold'
    ...
    validateView_year(message: string,) {
        switch (message) {
            case '2022':
                ...
                category5 = 'Consulting Cost'
                category6 = 'Due Diligence Cost'
                category7 = 'External Audit'
                category8 = 'Man Cost'
                category9 = 'Tech Cost'
                ...
                subcategory4 = 'Others'
                subcategory5 = 'Tokenomist'
                subcategory6 = 'Operation'
                subcategory7 = 'Smart Contract Audit'
                subcategory8 = 'Programmer'
                subcategory9 = 'Project Owner'
                subcategory10 = 'Tester'
                subcategory11 = 'UX/UI Design'
                subcategory12 = 'Platform'
                subcategory13 = 'Smart Contract'
                amountTHB1 = '777.00'
                amountTHB2 = '333.00'
                amountTHB3 = '3,521.00'
                amountTHB4 = '3,664.00'
